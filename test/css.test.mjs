...
test('Task 36/64: кадр героя растворяется длинной градиент-маской, кромки глазом не найти', () => {
  ...
  /* В старте заголовок первого ряда стоит в 12 % высоты кадра от его низа
     ...
     Между стопами .08 на 10 % и .4 на 24 % интерполяция даёт там около .13
     от картинки, и под «Сейчас смотрят» её практически не видно; подними
     второй стоп — и заголовок ляжет на кадр. */
