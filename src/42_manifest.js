    ...
    var DEFAULT = {
      ...
      collections: [
        ...
        /* Раунд holB: праздники СНГ и времена года (пользователь: «праздников
           много, есть ещё тематики пор года — можно всё это добавить»). Пять
           сезонных подборок; сезон — месяцы, как у прочих (план главной
           показывает сезонную только в её месяц, src/47_homeplan.js). Стоят
           ПОСЛЕ «Кино о любви»: лидер февраля прежний. Каждая проверена
           живым запросом TMDB через Lampa (ru-RU, 2026-09-26), первые 20:
           - «Зимнее кино» (январь–февраль; декабрь — Новый год и адвент):
             снег, зима, метель (1442|10794|3373) в уютных жанрах — комедия,
             семейное, романтика, фэнтези, анимация, приключения; без ужасов,
             триллеров, криминала, войны, вестернов и фантастики и без
             рождественского (207317 — у него свои подборки): «Холодное
             сердце» 1–2, «Нарния», «Приключения Флика», «Эдвард
             руки-ножницы», «День сурка», «Смолфут», «Эверест», «Между нами
             горы», «Джейн Эйр», «Альфа», «Крутые виражи». Без фильтра жанров
             первыми шли «Выживший», «Фарго» и «Крепкий орешек 2».
           - «Покорители космоса» (апрель, к 12 апреля): космонавт,
             космическая программа (и советская), космическая гонка, высадка
             на Луну, «Аполлон» (198136|229169|306201|156836|7422|226233),
             без ужасов и документального: «Скрытые фигуры», «Человек на
             Луне», «Аполлон 13», «Парни что надо», «Салют-7», «Время
             первых», «Лунный флаг». Общий «Космос» (ключевое слово space)
             живёт круглый год, здесь — история полётов.
           - «Летнее кино» (июнь–август): лето, каникулы, летний лагерь
             (13088|14714|5767) в семейных жанрах, до PG-13 по американскому
             рейтингу: без него в первой двадцатке стояли «Без обид», «С кем
             переспать?!!» и «Американский пирог 2». С ним — «Ловушка для
             родителей», «Монстры на каникулах 3», «Семейка Аддамс»,
             «Дневник слабака 3», «Скуби-Ду», «Camp Rock», «Лето. Пляж. Кино».
           - «Советские мультфильмы» (июнь, к 1 июня): анимация на русском
             до 1992 года, по числу оценок: «Ёжик в тумане», «Винни-Пух»,
             «Жил-был пёс», «Сказка сказок», «Трое из Простоквашино»,
             «Бременские музыканты», «Малыш и Карлсон», «Чебурашка»,
             «Маугли». Общие «Мультфильмы» — голливудские.
           - «Школьные годы» (сентябрь, к 1 сентября): старшая школа и
             первый день в школе (6270|173642), без ужасов, триллеров,
             фэнтези, фантастики и боевиков (иначе — весь «Гарри Поттер»),
             до PG-13: «Твоё имя», «Как стать принцессой», «10 причин моей
             ненависти», «Бриолин», «Хорошо быть тихоней», «Форма голоса»,
             «Фабельманы», «Тренер Картер», «Писатели свободы», «Выходной
             день Ферриса Бьюллера». Школьное советское кино (ключевые слова
             TMDB с orig_lang ru) дало семь случайных фильмов — не взято.
           23 февраля и 8 марта — без подборок: «армейское» кино по-русски
      ...
      /* Task 21 (фаза 3): правила тематических атмосфер. Порядок значим —
         ...
         Финальная проверка, B8: у christmas и halloween при «Только
         сезонные» months не действует — сцена фильма живёт в окне праздника
         (1.12–7.01 и 25.10–1.11, HOLIDAYS в src/53_themes.js). */
      themes: [
