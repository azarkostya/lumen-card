  ...
  LC.slideshow = (function () {
    ...
    /* Длительность кроссфейда — должна совпадать с opacity-transition
       .lumen-bg__img в src/30_css.js (transition:opacity .6s ease-in-out;
       с 2026-09-24 он есть только в full при тяжёлых эффектах, в lite смена
       резкая — лишние 0,6 с тёплого уходящего кадра там ничего не стоят;
       волна производительности укоротила переход с 1,2 с, совпадение
       сверяет test/css.test.mjs).
