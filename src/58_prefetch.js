  ...
  LC.prefetch = (function () {
    ...
    /* Ревью H1: срок запроса деталей (разбор у send). Живой запрос Lampa
       сама обрывает через 10 с и зовёт onerror (get$c ставит
       network.timeout(1000 * 10), vendor/lampa/app.min.js:19700), поэтому
       12 с срабатывают только на запросе, чьи колбэки Lampa выбросила. */
