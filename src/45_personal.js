/* -------------------------------------------------------------------- */
  ...
  LC.personal = (function () {
    ...
    /*                                                                     */
    /* Число теперь СВОЁ, не общее с WATCHED (95 в src/44_rows.js,         */
    /* src/66_franchise.js и src/70_progress.js) и не с PROGRESS_MAX       */
    /* (95 в src/62_badges.js).                                            */
    ...
    /* Заголовок ряда «Потому что вы смотрели: «X»» по исходному фильму.
       ...
       Финальная проверка, SEC-1: название из истории Lampa (TMDB) идёт без
       «<» и «>» — правило safeText каталога. Заголовок ряда Lampa рисует в
       «Настройки → Каналы» склейкой строк (field.name, app.min.js:8484), и
       разметка в названии там исполнялась бы. Не esc: на главной заголовок
       идёт текстовым узлом, и сущности стали бы видны буквально. */
