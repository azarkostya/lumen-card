  ...
  /* Правка пользователя 2026-09-17 (п.2): сменили размер кадра над рядами.
     ...
     Правка 2026-09-17 (второй круг): чипы настроения живут своим узлом в
     корне активности и размера героя не касаются — при «Выключен» они
     остаются на экране (раскладка опускает под них ряды), а пересобирать их
     при смене размера не нужно: узел героя им не родитель. Монтирование
     здесь нужно ровно для одного случая — чипов на главной ещё нет. */
