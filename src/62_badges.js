  ...
  LC.badges = (function () {
    ...
    /* Одна карточка. node — jQuery-узел или DOM-элемент .card, card — его
       ...
       правила A2 ниже). Ставит его сетка подборки и хаб (src/46_hub.js):
       их карточка 12.36em против 9.52em у главной.
    ...
    function decorate(node, card, opts) {
      try {
        ...
        /* A2, уточнение ревью волны A (важное 2): рейтинг в подписи — когда
           ...
           СЕТКА И ХАБ, доступно 140.5 / 138.3 / 136.1 / 133.9 px (карточка
