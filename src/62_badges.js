  ...
  LC.badges = (function () {
    ...
    /* Одна карточка. node — jQuery-узел или DOM-элемент .card, card — его
       ...
       правила A2 ниже). Ставит его сетка подборки — единственное место во
       всём src/, откуда decorate вообще зовётся (cardNode в
       src/46_hub.js): её карточка .lumen-gcard 12.36em против 9.52em у
