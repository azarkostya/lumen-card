  ...
  LC.ambient = (function () {
    ...
    /* Размер кадра TMDB под ширину экрана в физических пикселях.
       ...
       кадр героя, и разъезжаться этим трём размерам незачем. Порог там
       выше (1920): прежние 1366 отправляли в 'original' любой Full HD, а
       на нём w1280 растягивается всего в полтора раза — на фотографии за
       текстом этого не видно, тогда как original весит втрое дороже. */
