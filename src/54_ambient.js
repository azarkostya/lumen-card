  ...
  LC.ambient = (function () {
    ...
    /* Размер кадра TMDB под ширину экрана в физических пикселях. Порог
       1366 — типичная ширина ТВ-браузера HD-панели: 'original' там весит
       втрое дороже и не даёт ни одного лишнего пикселя. */
