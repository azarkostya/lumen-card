  ...
  LC.buildCss = function () {
    ...
    /* Правка 2026-09-23 (разбор композиции, п.1.4, вторая половина): верхняя
       ...
       Высота — LAMPA_HEAD (высота шапки) на полной плотности и столько же
       на затухание: низ глифов часов стоит на 2.7em от верха экрана (замер
       там же), то есть внутри полосы полной плотности. Плотность .5 даёт на
       белом кадре 3.73:1 при пороге 3:1 для крупного текста и графики
       (часы — 22.8 CSS px полужирным, это large text по WCAG 2.1).
