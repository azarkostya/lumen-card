  ...
  LC.buildCss = function () {
    ...
    /* Правка 2026-09-23 (разбор композиции, п.1.5): штатная кнопка «Ещё» из
       ...
       ленту — проверка на стенде 960×540@2 показала, что такая плитка там
       уже есть и делает ровно то же самое: Lampa дописывает в конец ряда
       .card-more.selector габаритом ровно в карточку (замер: 108.6×196.2 px
       при карточке 108.6×196.2), и фокус доезжает до неё, догоняя конец
       ряда. То есть в шапке стоял ДУБЛЬ, а не единственный вход.
