  ...
  LC.buildCss = function () {
    ...
    /* Правка пользователя 2026-09-17 (третий круг): фон под рядами — это фон
       ...
       по 100 мс, 1.6 с на путь (src/57_color.js), и красит он четыре
       правила подкраски разом, включая три градиентных (пятое, подсветку
       карточки под фокусом, промежуточный цвет не трогает — она стоит на
       токенах и с ревью Task 60 живёт в своём узле). Этому переходу
