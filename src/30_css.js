  ...
  LC.buildCss = function () {
    ...
    /* Task 51: зазор между карточками ряда — 1.75em (40 физ. px), тот же, что
       ...
       22.8 физ. px — ровно он и стоял здесь до Task 51.
       Классы .items-cards и .mapping--line Lampa вешает на ОДИН узел — тело
       горизонтального скролла ряда (app.min.js:52663), — поэтому наш селектор
       и перебивает штатный (два класса против одного), и не задевает другие
       списки с .mapping--line: под .lumen-main их нет, а за его пределами
