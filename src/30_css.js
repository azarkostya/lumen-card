  ...
  LC.buildCss = function () {
    ...
    /* A3: панель «Просмотрено …» на постере ряда — штатная, не наша. Её
       ...
       стоит ничего: Controller.collectionSet отбирает узлы по
       offsetParent !== null (app.min.js:46448-46455), и display:none уводит
       панель из набора вместе с её содержимым.
