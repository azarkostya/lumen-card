  ...
  /*  - подкраска фона (подложка рядов и вуали героя) живёт в собственном  */
  /*    узле <style id="lumen-accent">: на главной доминанта меняется на   */
  /*    каждой остановке фокуса, и пересобирать ради неё всю таблицу       */
  /*    плагина — фриз ровно в момент листания ряда;                       */
