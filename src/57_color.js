  ...
  LC.accent = (function () {
    ...
    /* Гейт режима анимаций — общий для расчёта (on ниже), подкраски фона
       ...
       смена доминанты теперь переписывает один маленький <style> (пять
       правил, 822 байта) и ничего не анимирует, так что «лёгким анимациям»
       подкраска не противопоказана. А на ТВ это и есть рабочий режим:
    ...
    /* Правка пользователя 2026-09-17 (третий круг): фон страницы получает
       ...
       она; плавность перехода цвета и так живёт отдельным правилом только
       при полных анимациях (body.lumen-motion-full .lumen-main). */
