  ...
  LC.accent = (function () {
    ...
    /* Task 60, жалоба пользователя: «надо сделать это плавным очень, без
       ...
       шестнадцати. Раунд «Листание», F3 (трейс 2026-09-25, CPU ×10): одна
       смена цвета стоила 259 мс главного потока, из них растр 92, — шаг
       400 мс, четыре записи за путь: 160 и 45 мс. Путь через приглушённый
       тон при четырёх шагах сохраняется (середина — второй шаг).
       Длительность пути прежняя, и только в режиме полных анимаций — в
       'lite' (куда уводит автодетект слабого ТВ) цвет ставится сразу. */
    var TWEEN_MS = 1600;
    ...
    /* Гейт режима анимаций — общий для расчёта (on ниже), подкраски фона
       ...
       мгновенный — там это одна запись, а не четыре. А на ТВ это и есть рабочий режим:
