  ...
  /* десятки плиток с коллажами. Теперь замер начинают и монтирование      */
  ...
  LC.perf = (function () {
    ...
    /* Task 40: «железо заведомо слабое» — вердикт без единого замера.
       ...
       Четырёхъядерный ТВ пользователя (Philips 50PUS8057, MediaTek, 4 ядра)
       под правило НЕ попадает — там по-прежнему решает замер.
