  ...
  /* лежит в Storage 'lumen_motion_auto' — {mode, good}. Записанный вердикт*/
  /* измерение не отменяет: каждый запуск меряет заново, потому что три    */
  /* первые карточки — самые холодные, и один их вердикт не имеет права    */
  /* стать вечным (ревью фазы 3, Important 3).                             */
  /*                                                                       */
