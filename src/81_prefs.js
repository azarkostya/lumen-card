  ...
  LC.prefs = (function () {
    ...
    /* Task 62b (фаза 5): готовый стиль — НАБОР ЗНАЧЕНИЙ существующих
       ...
       Два ключа — lumen_hero_size и lumen_accent_auto — в стиле Apple TV
       совпадают со значениями по умолчанию, и всё же входят в набор: стиль
       обязан быть ПОЛНЫМ состоянием, а не разницей. Иначе человек с
       «Кадром над рядами → Выключен» получил бы «стиль Apple TV» без
       кадра, а нажатие «Вернуть стиль Lumen» не вернуло бы его. Оба ключа
       стоят и в согласованной таблице задачи (task62-detail.md, строки
       «lumen_accent_auto ... true / true» и «lumen_hero_size ... large /
       large»), так что это не расширение набора, а его буквальное
