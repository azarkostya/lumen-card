  ...
  LC.prefs = (function () {
    ...
    var LIST = [
      ...
      /* Правка 2026-09-23 (просьба пользователя): что показывает кадр —
         один кадр с автотрейлером (как было, дефолт) или несколько кадров
         по кругу без трейлера. Место — сразу за размером кадра: настройка
      ...
      /* Task 74: откуда берётся сам постер. Место — перед метками: метка
  ...
  /* Task 74: источник постера карточки — ОДНА точка чтения на весь плагин
