    ...
    /* Сквозной проход по рядам одной пачки, сверху вниз.
       ...
       Два наших флага на ряду:
         lumen_personal — состав не трогаем вовсе, но карточки в окно
           ...
           Следующий раунд, п.1 (ревью): тот же флаг и у ряда адвента. Его
           окошко — день календаря: 31 декабря «Ирония судьбы» стоит и в
           «Досмотреть» (lumen_own ниже кладёт её в окно заранее), и
           вырезанное окошко 31-го оставляло дыру в календаре, а фокус «на
           сегодня» (focusToday) — без сегодняшнего окошка. Ряды ниже себя
           адвент чистит, как прежде; lumen_own у него нет — ряды выше он
           не трогает.
        ...
        return function (call) {
          ...
          function build(extra, opened) {
            ...
            /* Task 57: ряд адвента из-под порога длины выведен флагом.
               ...
               календаря, и выброшенный фильм оставлял бы в нём дыру. */
            var payload = {
